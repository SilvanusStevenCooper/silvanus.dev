...
const Works = () => {
  ...
  return (
    <div id="works" className="w-full h-full items-center justify-center">
      <Heading title="Works" />
      <motion.section
        initial={{ opacity: 0 }}
        animate={{
        ...
        className="h-full min-h-[80vh] flex flex-col justify-center pt-10 pb-10 xl:pt-10 xl:mb-16"
      >
          ...
          order-2 xl:order-none group"
            >
              <div className="flex flex-col gap-4 ">
                {/* outline number */}
                <div
                  className="text-4xl leading-none font-extrabold group-hover:text-accent 
              ...
              group-hover:text-accent transition-all duration-500 capitalize"
                ...
                <div>
                  <label
                    className="text-2xl w-full font-bold leading-none text-white 
