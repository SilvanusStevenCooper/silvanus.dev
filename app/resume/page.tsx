...
const ResumePage = () => {
  return (
    <motion.div
      ...
      className="h-full flex items-center justify-center py-12 xl:py-0 relative"
    >
      <div className=" container mx-auto ">
        <Tabs
          defaultValue="experience"
          className="flex h-full flex-col xl:flex-row gap-[60px] "
        >
          <TabsList
            className="flex flex-col xl:fixed xl:left-[4.5rem] xl:top-[10rem] w-full max-w-[380px] 
          ...
          {/* content */}
          <div className="min-h-[70vh] w-auto xl:absolute xl:left-[500px] xl:top-[10rem] xl:pr-16 xl:pb-20">
            <TabsContent value="experience" className="w-full pb-10">
            ...
            {/* Skills */}
            <TabsContent value="skills" className="w-full h-full pb-10">
            ...
            <TabsContent value="about" className="w-full text-left pb-10">
              <div className="flex flex-col gap-[30px]">
                <h3 className="text-4xl font-bold">{about.title}</h3>
                <p className="w-auto text-white mx-auto xl:mx-0">
                  {about.description}
                </p>
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 w-auto  xl:mx-0">
